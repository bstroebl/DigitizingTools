# -*- coding: utf-8 -*-
#
# digitizingtools documentation build configuration file, created by
...
latex_documents = [
  ('index', 'digitizingtools.tex', u'DigitizingTools Documentation',
...
man_pages = [
    ('index', 'templateclass', u'DigitizingTools Documentation',
