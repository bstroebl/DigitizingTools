...
TOOLS = tools/dtutils.py tools/dtsplitmultipart.py tools/dtcutter.py tools/dtsplitter.py tools/dtprolongline.py tools/dtprolonglinetool.py tools/dtmovenodebyarea.py tools/dtmovesidebydistance.py tools/dtselectvertextool.py tools/dtselectsegmenttool.py tools/ui_dtmovenodebyarea.py tools/ui_dtmovesidebydistance.py tools/dtmovenodebyarea_dialog.py tools/dtmovesidebydistance_dialog.py 
